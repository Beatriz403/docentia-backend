...
const DocentIA = {
  ...
  API_URL: (() => {
    ...
    if (
      ...
      return "https://docentia-backend.onrender.com"; // ← CAMBIAR POR TU URL DE RENDER
    }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (DocentIA.isDevelopment) {
    ...
    console.log(
      "🌍 Entorno:",
      DocentIA.isDevelopment ? "DESARROLLO" : "PRODUCCIÓN"
    );
  ...
  if (btnLimpiar) {
    const form =
      document.getElementById("problemasForm") ||
  ...
  const btnNuevos =
    document.getElementById("btnNuevos") || document.getElementById("btnNueva");
  if (btnNuevos) {
    const form =
      document.getElementById("problemasForm") ||
      document.getElementById("emergenciaForm") ||
